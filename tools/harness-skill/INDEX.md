# Harness Skill - AI Reference Documentation Index

A harness for AI agents to develop, test, and debug features in RecipeManager with a streamlined workflow and best practices.
...
3. Creates a plan at `/plans/{slug}.json`
