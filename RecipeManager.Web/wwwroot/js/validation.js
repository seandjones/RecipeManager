 ...
 */
export function updateInputValidation(element, isValid) {
    if (!element) {
        return;
    }
 ...
 * @param element - The input element
 */
export function clearInputValidation(element) {
    if (!element) {
        return;
    }
    element.classList.remove('is-valid', 'is-invalid');
 ...
 * @param element - The input element
 */
export function setupAutoTrim(element) {
    if (!element) {
        return;
    }
